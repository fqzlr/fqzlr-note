...
- 更新 [返回顶部](./layout.md#返回顶部) 组件，加入下滑进度条显示
...
- 新增 [首页特性页卡悬停效果](./style.md#首页特性悬停效果)
...
- 更新 [鼠标例子效果](./components.md#鼠标粒子效果)，弃用animejs

- 修正部分文字错误

- 更新 [返回顶部组件](./layout.md#返回顶部)

- 全面更新 [布局插槽](./layout.md) 教程



## 2025-6-17

- 更新 [首页文字下划线组件](./components.md#首页文字下划线)

## 2025-6-13

- 新增 [代码块添加图片功能](./style.md#代码组中添加图片)
